...
//            std::vector<MaterialType> mat_;
//            std::vector<PhaseType> phase_;
//
...
//                mat_ = std::vector<MaterialType>(newPartNum, MaterialType::FLUID);
//            else if (obj["mat"].get<std::string>() == "rigid")
//                mat_ = std::vector<MaterialType>(newPartNum, MaterialType::RIGID);
//            else if (obj["mat"].get<std::string>() == "elastic")
//                mat_ = std::vector<MaterialType>(newPartNum, MaterialType::ELASTIC);
//            else if (obj["mat"].get<std::string>() == "bound")
//                mat_ = std::vector<MaterialType>(newPartNum, MaterialType::BOUND);
//            mat.insert(mat.end(), mat_.begin(), mat_.end());
//
//            if (obj["phase"] == 1)
//                phase_ = std::vector<PhaseType>(newPartNum, PhaseType::PHASE1);
//            else if (obj["phase"] == 2)
//                phase_ = std::vector<PhaseType>(newPartNum, PhaseType::PHASE2);
