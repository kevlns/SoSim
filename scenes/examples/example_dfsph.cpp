...
int main() {
    ...
    auto solver = solverManager.createSolver<DFSPHSolver>();
    auto solver_config = dynamic_cast<DFSPHSolverConfig *>(solver->getConfig().get());
    ...
    solver_config->export_path = "F:\\DataSet.Research\\SoSimExamples\\DFSPH";
