...
int main() {
    ...
    cubeConfig_1->lb = {-1.3, -1, -1};
    cubeConfig_1->size = {2, 3.5, 2};
    ...
    boxConfig->shape = "box";
    boxConfig->lb = {-2, -1.5, -2};
    boxConfig->size = {4, 5, 4};
    boxConfig->layer = 2;
    box_1->setName("box_1");
    box_1->update();
    ...
    solver_config->Cf = 0.001;
    solver_config->Cd = 0.4;
