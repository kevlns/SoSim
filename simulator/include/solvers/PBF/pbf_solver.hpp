...
#ifndef SOSIM_PBF_SOLVER_HPP
#define SOSIM_PBF_SOLVER_HPP
...
#include "pbf_parameters.hpp"

namespace SoSim {

    struct PBFSolverConfig : public SolverConfig {
        // common
        float dt{1 / 60.f};
    ...
    private:
        ...
        PBFConstantParams m_host_const;
        PBFConstantParams *m_device_const{nullptr};
        PBFDynamicParams m_host_data;
        PBFDynamicParams *m_device_data{nullptr};
