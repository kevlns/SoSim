...
namespace SoSim {
    __global__ void
    init_data_cuda(IMMCTConstantParams *d_const,
    ...
    __global__ void
    update_rest_density_and_mass_cuda(IMMCTConstantParams *d_const,
                                      IMMCTDynamicParams *d_data,
                                      NeighborSearchUGParams *d_nsParams) {
        CHECK_THREAD();
    ...
    __global__ void
    update_color_cuda(IMMCTConstantParams *d_const,
                      IMMCTDynamicParams *d_data,
                      NeighborSearchUGParams *d_nsParams) {
        CHECK_THREAD();
    ...
    __global__ void
    recover_phase_vel_from_mixture_cuda(IMMCTConstantParams *d_const,
                                        IMMCTDynamicParams *d_data,
                                        NeighborSearchUGParams *d_nsParams) {
        CHECK_THREAD();
    ...
    __global__ void
    compute_rigid_volume(IMMCTConstantParams *d_const,
                         IMMCTDynamicParams *d_data,
    ...
    __global__ void
    compute_compression_ratio_cuda(IMMCTConstantParams *d_const,
                                   IMMCTDynamicParams *d_data,
                                   NeighborSearchUGConfig *d_nsConfig,
                                   NeighborSearchUGParams *d_nsParams) {
        CHECK_THREAD();
    ...
    __global__ void
    compute_df_beta_cuda(IMMCTConstantParams *d_const,
                         IMMCTDynamicParams *d_data,
                         NeighborSearchUGConfig *d_nsConfig,
                         NeighborSearchUGParams *d_nsParams) {
        CHECK_THREAD();
    ...
    __global__ void
    compute_delta_compression_ratio_cuda(IMMCTConstantParams *d_const,
                                         IMMCTDynamicParams *d_data,
                                         NeighborSearchUGParams *d_nsParams) {
        CHECK_THREAD();
    ...
    __global__ void
    update_delta_compression_ratio_from_vel_adv_cuda(IMMCTConstantParams *d_const,
                                                     IMMCTDynamicParams *d_data,
                                                     NeighborSearchUGConfig *d_nsConfig,
                                                     NeighborSearchUGParams *d_nsParams) {
        CHECK_THREAD();
    ...
    __global__ void
    compute_kappa_div_from_delta_compression_ratio_cuda(IMMCTConstantParams *d_const,
                                                        IMMCTDynamicParams *d_data,
                                                        NeighborSearchUGParams *d_nsParams) {
        CHECK_THREAD();
    ...
    __global__ void
    vf_update_vel_adv_from_kappa_div_cuda(IMMCTConstantParams *d_const,
                                          IMMCTDynamicParams *d_data,
                                          NeighborSearchUGConfig *d_nsConfig,
                                          NeighborSearchUGParams *d_nsParams) {
        CHECK_THREAD();
    ...
    __global__ void
    log_kappa_div_cuda(IMMCTConstantParams *d_const,
                       IMMCTDynamicParams *d_data,
                       NeighborSearchUGParams *d_nsParams) {
        CHECK_THREAD();
    ...
    __global__ void
    clear_phase_acc_cuda(IMMCTConstantParams *d_const,
                         IMMCTDynamicParams *d_data,
                         NeighborSearchUGParams *d_nsParams) {
        CHECK_THREAD();
    ...
    __global__ void
    add_phase_acc_gravity_cuda(IMMCTConstantParams *d_const,
                               IMMCTDynamicParams *d_data,
                               NeighborSearchUGParams *d_nsParams) {
        CHECK_THREAD();
    ...
    __global__ void
    add_phase_acc_vis_cuda(IMMCTConstantParams *d_const,
                           IMMCTDynamicParams *d_data,
                           NeighborSearchUGConfig *d_nsConfig,
                           NeighborSearchUGParams *d_nsParams) {
        CHECK_THREAD();
    ...
    __global__ void
    add_phase_acc_dfsph_vis_cuda(IMMCTConstantParams *d_const,
                                 IMMCTDynamicParams *d_data,
                                 NeighborSearchUGConfig *d_nsConfig,
                                 NeighborSearchUGParams *d_nsParams) {
        CHECK_THREAD();
    ...
    __global__ void
    compute_surface_normal_cuda(IMMCTConstantParams *d_const,
                                IMMCTDynamicParams *d_data,
                                NeighborSearchUGConfig *d_nsConfig,
                                NeighborSearchUGParams *d_nsParams) {
        CHECK_THREAD();
    ...
    __global__ void
    add_phase_acc_surface_tension_cuda(IMMCTConstantParams *d_const,
                                       IMMCTDynamicParams *d_data,
                                       NeighborSearchUGConfig *d_nsConfig,
                                       NeighborSearchUGParams *d_nsParams) {
        CHECK_THREAD();
    ...
    __global__ void
    add_phase_acc_adhesion_cuda(IMMCTConstantParams *d_const,
                                IMMCTDynamicParams *d_data,
                                NeighborSearchUGConfig *d_nsConfig,
                                NeighborSearchUGParams *d_nsParams) {
        CHECK_THREAD();
    ...
    __global__ void
    correct_phase_vel_by_vis_bound_cuda(IMMCTConstantParams *d_const,
                                        IMMCTDynamicParams *d_data,
                                        NeighborSearchUGConfig *d_nsConfig,
                                        NeighborSearchUGParams *d_nsParams) {
        CHECK_THREAD();
    ...
    __global__ void
    phase_acc_2_phase_vel_cuda(IMMCTConstantParams *d_const,
                               IMMCTDynamicParams *d_data,
                               NeighborSearchUGParams *d_nsParams) {
        CHECK_THREAD();
    ...
    __global__ void
    update_vel_from_phase_vel_cuda(IMMCTConstantParams *d_const,
                                   IMMCTDynamicParams *d_data,
                                   NeighborSearchUGParams *d_nsParams) {
        CHECK_THREAD();
    ...
    __global__ void
    get_acc_pressure_cuda(IMMCTConstantParams *d_const,
                          IMMCTDynamicParams *d_data,
                          NeighborSearchUGParams *d_nsParams) {
        CHECK_THREAD();
    ...
    __global__ void
    distribute_acc_pressure_2_phase_cuda(IMMCTConstantParams *d_const,
                                         IMMCTDynamicParams *d_data,
                                         NeighborSearchUGParams *d_nsParams) {
        CHECK_THREAD();
    ...
    __global__ void
    compute_kappa_incomp_from_delta_compression_ratio_cuda(IMMCTConstantParams *d_const,
                                                           IMMCTDynamicParams *d_data,
                                                           NeighborSearchUGParams *d_nsParams) {
        CHECK_THREAD();
    ...
    __global__ void
    vf_update_vel_adv_from_kappa_incomp_cuda(IMMCTConstantParams *d_const,
                                             IMMCTDynamicParams *d_data,
                                             NeighborSearchUGConfig *d_nsConfig,
                                             NeighborSearchUGParams *d_nsParams) {
        CHECK_THREAD();
    ...
    __global__ void
    update_pos_cuda(IMMCTConstantParams *d_const,
                    IMMCTDynamicParams *d_data,
                    NeighborSearchUGParams *d_nsParams) {
        CHECK_THREAD();
    ...
    __global__ void
    clear_val_frac_tmp_cuda(IMMCTConstantParams *d_const,
                            IMMCTDynamicParams *d_data,
                            NeighborSearchUGParams *d_nsParams) {
        CHECK_THREAD();
    ...
    __global__ void
    update_phase_change_from_drift_cuda(IMMCTConstantParams *d_const,
                                        IMMCTDynamicParams *d_data,
                                        NeighborSearchUGConfig *d_nsConfig,
                                        NeighborSearchUGParams *d_nsParams) {
        CHECK_THREAD();
    ...
    __global__ void
    update_phase_change_from_diffuse_cuda(IMMCTConstantParams *d_const,
                                          IMMCTDynamicParams *d_data,
                                          NeighborSearchUGConfig *d_nsConfig,
                                          NeighborSearchUGParams *d_nsParams) {
        CHECK_THREAD();
    ...
    __global__ void
    check_negative_cuda(IMMCTConstantParams *d_const,
                        IMMCTDynamicParams *d_data,
                        NeighborSearchUGParams *d_nsParams) {
        CHECK_THREAD();
    ...
    __global__ void
    update_phase_change_cuda(IMMCTConstantParams *d_const,
                             IMMCTDynamicParams *d_data,
                             NeighborSearchUGParams *d_nsParams) {
        CHECK_THREAD();
    ...
    __global__ void
    release_unused_drift_vel_cuda(IMMCTConstantParams *d_const,
                                  IMMCTDynamicParams *d_data,
                                  NeighborSearchUGParams *d_nsParams) {
        CHECK_THREAD();
    ...
    __global__ void
    release_negative_cuda(IMMCTConstantParams *d_const,
                          IMMCTDynamicParams *d_data,
                          NeighborSearchUGParams *d_nsParams) {
        CHECK_THREAD();
    ...
    __global__ void
    regularize_val_frac_cuda(IMMCTConstantParams *d_const,
                             IMMCTDynamicParams *d_data,
                             NeighborSearchUGParams *d_nsParams) {
        CHECK_THREAD();
    ...
    __global__ void
    estimate_density_cuda(IMMCTConstantParams *d_const,
                          IMMCTDynamicParams *d_data,
                          NeighborSearchUGConfig *d_nsConfig,
                          NeighborSearchUGParams *d_nsParams) {
        CHECK_THREAD();
    ...
    __global__ void
    compute_vel_grad_cuda(IMMCTConstantParams *d_const,
                          IMMCTDynamicParams *d_data,
                          NeighborSearchUGConfig *d_nsConfig,
                          NeighborSearchUGParams *d_nsParams) {
        CHECK_THREAD();
    ...
    __global__ void
    update_conformation_tensor_cuda(IMMCTConstantParams *d_const,
                                    IMMCTDynamicParams *d_data,
                                    NeighborSearchUGParams *d_nsParams) {
        CHECK_THREAD();
    ...
    __global__ void
    add_viscoelastic_acc_cuda(IMMCTConstantParams *d_const,
                              IMMCTDynamicParams *d_data,
                              NeighborSearchUGConfig *d_nsConfig,
                              NeighborSearchUGParams *d_nsParams) {
        CHECK_THREAD();
    ...
    __global__ void
    update_Cd_cuda(IMMCTConstantParams *d_const,
                   IMMCTDynamicParams *d_data,
                   NeighborSearchUGConfig *d_nsConfig,
                   NeighborSearchUGParams *d_nsParams) {
        CHECK_THREAD();
    ...
    __global__ void
    compute_shear_exp_cuda(IMMCTConstantParams *d_const,
                           IMMCTDynamicParams *d_data,
                           NeighborSearchUGParams *d_nsParams) {
        CHECK_THREAD();
...
namespace SoSim { // extra func cuda impl
    __global__ void
    stir_fan_cuda(IMMCTConstantParams *d_const,
                  IMMCTDynamicParams *d_data,
                  NeighborSearchUGParams *d_nsParams) {
        CHECK_THREAD();
    ...
    __global__ void
    buckling_move_cuda(IMMCTConstantParams *d_const,
                       IMMCTDynamicParams *d_data,
                       NeighborSearchUGParams *d_nsParams) {
        CHECK_THREAD();
    ...
    __global__ void
    rotate_bowl_cuda(IMMCTConstantParams *d_const,
                     IMMCTDynamicParams *d_data,
                     NeighborSearchUGParams *d_nsParams) {
        CHECK_THREAD();
    ...
    __global__ void
    correct_phase_vel_by_artificial_vis_bound_cuda(IMMCTConstantParams *d_const,
                                                   IMMCTDynamicParams *d_data,
                                                   NeighborSearchUGConfig *d_nsConfig,
                                                   NeighborSearchUGParams *d_nsParams) {
        CHECK_THREAD();
...
//                d_const, d_data, d_nsParams);
    ...
    __host__ void
    update_color(IMMCTConstantParams &h_const,
                 IMMCTConstantParams *d_const,
                 IMMCTDynamicParams *d_data,
                 NeighborSearchUGParams *d_nsParams) {
        // get_acc_pressure()
