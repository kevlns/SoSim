...
#include "vis_pbf_macro.hpp"
#include "libs/SPHKernelL/kernels.cuh"

namespace SoSim { // cuda kernels
    __global__ void
    init_cuda(VisPBFConstantParams *d_const,
    ...
    __global__ void
    compute_rigid_particle_volume_cuda(VisPBFConstantParams *d_const,
                                       VisPBFDynamicParams *d_data,
    ...
    __global__ void
    compute_sph_density_and_error_cuda(VisPBFConstantParams *d_const,
                                       VisPBFDynamicParams *d_data,
                                       NeighborSearchUGConfig *d_nsConfig,
                                       NeighborSearchUGParams *d_nsParams) {
        CHECK_THREAD();
    ...
    __global__ void
    update_lamb_cuda(VisPBFConstantParams *d_const,
                     VisPBFDynamicParams *d_data,
                     NeighborSearchUGConfig *d_nsConfig,
                     NeighborSearchUGParams *d_nsParams) {
        CHECK_THREAD();
    ...
    __global__ void
    compute_dx_from_density_error_cuda(VisPBFConstantParams *d_const,
                                       VisPBFDynamicParams *d_data,
                                       NeighborSearchUGConfig *d_nsConfig,
                                       NeighborSearchUGParams *d_nsParams) {
        CHECK_THREAD();
    ...
    __global__ void
    compute_dx_from_vis_cuda(VisPBFConstantParams *d_const,
                             VisPBFDynamicParams *d_data,
                             NeighborSearchUGConfig *d_nsConfig,
                             NeighborSearchUGParams *d_nsParams) {
        CHECK_THREAD();
    ...
    __global__ void
    apply_ext_force_cuda(VisPBFConstantParams *d_const,
                         VisPBFDynamicParams *d_data,
                         NeighborSearchUGConfig *d_nsConfig,
                         NeighborSearchUGParams *d_nsParams) {
        CHECK_THREAD();
    ...
    __global__ void
    apply_dx_cuda(VisPBFConstantParams *d_const,
                  VisPBFDynamicParams *d_data,
                  NeighborSearchUGConfig *d_nsConfig,
                  NeighborSearchUGParams *d_nsParams) {
        CHECK_THREAD();
    ...
    __global__ void
    XSPH_cuda(VisPBFConstantParams *d_const,
              VisPBFDynamicParams *d_data,
              NeighborSearchUGConfig *d_nsConfig,
              NeighborSearchUGParams *d_nsParams) {
        CHECK_THREAD();
...
namespace SoSim { // host invoke api
    ...
    compute_dx(VisPBFConstantParams &h_const,
               ...
               NeighborSearchUGConfig *d_nsConfig,
               NeighborSearchUGParams *d_nsParams) {
        // compute_dx_from_density_error_cuda
        compute_dx_from_density_error_cuda<<<h_const.block_num, h_const.thread_num>>>(d_const,
                                                                                      d_data,
                                                                                      d_nsConfig,
                                                                                      d_nsParams);

        // TODO compute_dx_from_vis_cuda
        compute_dx_from_vis_cuda<<<h_const.block_num, h_const.thread_num>>>(d_const,
                                                                            d_data,
                                                                            d_nsConfig,
                                                                            d_nsParams);
    }
